  ...
  return (
    <div className="w-full max-w-2xl mx-auto text-center py-20 space-y-8">
      <div className="relative w-32 h-32 mx-auto">
        ...
        <div className="absolute inset-4 border-4 border-slate-200 rounded-full"></div>
      ...
      <div>
        <h3 className="text-xl font-bold text-slate-800 mb-2">Compressing Time...</h3>
        <p className="text-slate-500">Scanning news, releases, and shifts in the timeline.</p>
      </div>
